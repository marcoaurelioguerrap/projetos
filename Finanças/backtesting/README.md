...
Value at Risk<sub>&alpha;<\sub>(-Log Retornos) - \VaR<sub>&alpha;<\sub>(-Log Retornos) é uma medida de risco que é definida como o quantil $alpha da distribuição acumulada dos logs retornos negativos.   
